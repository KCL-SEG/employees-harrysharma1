...
class ContractEmployee(Employee):
    ...
    def __str__(self):
        return f'{self.name} works on a contract of {self.hoursWorked} at {self.hourlyRate}/hour. Their total pay is {self.get_pay}.'
...
class SalaryEmployee(Employee):
    ...
    def __str__(self):
        return f'{self.name} works on a monthly salary of {self.monthlyRate}. Their total pay is {self.get_pay}.'
...
class BonusComission_C(ContractEmployee):
    ...
    def get_pay(self):
        return super().get_pay()+self.bonus
    def __str__(self):
        return f'{self.name} works on a contract of {self.hoursWorked} hours at {self.hourlyRate}/hour and receives a bonus commission of {self.bonus}.  Their total pay is {self}.'
